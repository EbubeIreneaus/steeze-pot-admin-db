...
<template>
  <div>
    <div class="tw-grid tw-grid-cols-2 tw-gap-x-5 tw-gap-y-7">
      ...
      <q-card class="tw-col-span-1" flat>
        ...
        <q-card-section>
          <div class="text-subtitle q-mb-sm">Total Expenses</div>
          <div class="row">
            <div class="text-h5" v-money="todayExpense"></div>
            <q-icon name="expand_more" color="red-5"></q-icon>
            <div class="text-red-10">10%</div>
          </div>
          <div class="text-subtitle q-mt-md text-weight-light">Today</div>
        </q-card-section>
      </q-card>
      ...
      <q-card class="tw-col-span-1" flat>
        ...
        <q-card-section>
          <div class="text-subtitle q-mb-sm">Total Profit</div>
          <div class="row">
            <div class="text-h5" v-money="todayProfit"></div>
            <q-icon name="expand_less" color="green"></q-icon>
            <div class="text-green-5">10%</div>
          </div>
          <div class="text-subtitle q-mt-md text-weight-light">
      ...
      <q-card class="tw-col-span-1" flat>
        ...
        <q-card-section>
          <div class="text-subtitle q-mb-sm">Flex Cash</div>
          <div class="row">
            <div class="text-h5" v-money="todaySales - todayExpense"></div>
          </div>
          <div class="text-subtitle q-mt-md text-weight-light">
           Today Flex Cash
          </div>
